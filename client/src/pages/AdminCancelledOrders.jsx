...
import { Eye, Trash2, Edit2, X, Search, Filter, Ban } from 'lucide-react';
            ...
            <div className="admin-page">
                ...
                <div className="container">
                    <div className="loading-state">
                        <Ban size={48} />
                        <h1>Loading Cancelled Orders...</h1>
                    </div>
                </div>
            </div>
        );
            ...
            <div className="admin-container">
                <div className="admin-header">
                    <div>
                        ...
                        <p className="page-subtitle">View and manage cancelled orders</p>
                    </div>
